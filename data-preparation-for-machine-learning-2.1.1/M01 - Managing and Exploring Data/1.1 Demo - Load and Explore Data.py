...
# MAGIC %md
# MAGIC # Using Pyspark.Pandas

# COMMAND ----------

import pyspark.pandas as ps
telco_pdf = ps.DataFrame(telco_df)
telco_pdf.head()
...
telco_df.write.mode("ignore").saveAsTable(table_name_bronze) # will be stored under default catalog and schema
...
# MAGIC %sql
# MAGIC DESCRIBE HISTORY telco_missing_bronzeb

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM telco_missing_bronze  TIMESTAMP AS OF '2025-03-24T09:22:25.000+00:00'

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM telco_missing_bronze  version  AS OF 1
