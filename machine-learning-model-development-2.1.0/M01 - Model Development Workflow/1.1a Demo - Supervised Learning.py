...
# MAGIC %md
# MAGIC # Using standard sklearn for preprocessing
...
# MAGIC from sklearn.metrics import r2_score, mean_squared_error, mean_absolute_percentage_error
# MAGIC
# MAGIC # turn on autologging
# MAGIC mlflow.sklearn.autolog(log_input_examples=True)
# MAGIC
# MAGIC # apply the Standard Scaler to all our input columns
...
# MAGIC lr_mdl = lr.fit(X_train_scaled, y_train)
# MAGIC
# MAGIC # evaluate the test set
# MAGIC predicted = lr_mdl.predict(X_test_scaled)
# MAGIC test_r2 = r2_score(y_test, predicted)
# MAGIC test_mse = mean_squared_error(y_test, predicted)
# MAGIC test_rmse = sqrt(test_mse)
# MAGIC test_mape = mean_absolute_percentage_error(y_test, predicted)
# MAGIC print("Test evaluation summary:")
# MAGIC print(f"R^2: {test_r2}")
# MAGIC print(f"MSE: {test_mse}")
# MAGIC print(f"RMSE: {test_rmse}")
# MAGIC print(f"MAPE: {test_mape}")
