...
# Convert silhouette scores to a Spark DataFrame
silhouette_scores_df = spark.createDataFrame([(k, float(score)) for k, score in silhouette_scores], ["K", "Silhouette_Score"])

# Display the silhouette scores DataFrame
